...
class InsertQueryTest {
	...
	void insertTheme() {
		...
		AdmTheme[] themesArray = new AdmTheme[] {new AdmTheme("Action"),new AdmTheme("Aventure"),new AdmTheme("Exploration"),new AdmTheme("Horreur"),
				new AdmTheme("Enquête"),new AdmTheme("Moderne"),new AdmTheme("Médiéval"),new AdmTheme("Onirique"),new AdmTheme("Heroic fantasy"),
				new AdmTheme("Sorcellerie"),new AdmTheme("Conspiration"),new AdmTheme("Futuriste"),new AdmTheme("Démoniaque"),new AdmTheme("Aventures Spatiales"),
				new AdmTheme("Post apo"),new AdmTheme("Corruption"),new AdmTheme("Fin du monde"),new AdmTheme("Distopie"),new AdmTheme("Utopie"),
				new AdmTheme("Politique")};

		List<AdmTheme> themes = new ArrayList<AdmTheme>(Arrays.asList(themesArray));
		
		themes.stream().forEach(theme->{
			themeSrv.insert(theme);
		});
	...
	void insertGame() {
		...
		List<AdmTheme> themes2 = new ArrayList<>();
		themes2.add(themeSrv.getByName("Conspiration"));
		themes2.add(themeSrv.getByName("Enquête"));
		themes2.add(themeSrv.getByName("Action"));
